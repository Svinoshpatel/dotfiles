...
-- Widgets
local myvolume = require("widgets.volume_widget")
local mybrightness = require("widgets.brightness_widget")
local mytextclock = require("widgets.clock_widget")
...
beautiful.init("/home/svinoshpatel/.config/awesome/theme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist = awful.widget.taglist {
        ...
        style = {
            ...
            fg_focus = colorscheme.color['pink'],
            fg_occupied = colorscheme.color['text'],
            fg_urgent = colorscheme.color['mauve'],
        },
        widget_template = {
            {
                {
            ...
            bg = colorscheme.color['base'],
            fg = colorscheme.color['overlay0'],
        },
    }
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            spacing = 10,
            layout = wibox.layout.fixed.horizontal,
            mybrightness.container_brightness_widget,
            myvolume.container_volume_widget,
            mykeyboardlayout,
...
-- Timer for volume changing delay
local update_volume_timer = gears.timer {
    timeout = 0.1,
    autostart = false,
    callback = function()
...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86AudioRaiseVolume", function()
        awful.spawn("sh -c 'pactl set-sink-mute @DEFAULT_SINK@ false ; pactl set-sink-volume @DEFAULT_SINK@ +5%'")
        update_volume_timer:start() end,
