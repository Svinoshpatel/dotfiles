...
local function worker(user_args)
    ...
    local calendar_themes = {
        ...
        dark = {
            ...
            fg = colorscheme.color["text"],
            focus_date_bg = colorscheme.color["pink"],
            focus_date_fg = colorscheme.color["base"],
            weekend_day_bg = colorscheme.color["surface0"],
            weekday_fg = colorscheme.color["pink"],
            header_fg = colorscheme.color["subtext"],
            border = colorscheme.color["pink"]
        },
        light = {
            bg = '#ffffff',
            fg = '#000000',
